...
//     role: "system",
//     content: ageGroup
//       ? prompt + data_train_joven
//       : prompt + data_train_adolecente,
//   };
...
const Chat = ({ socket, username, room, ageGroup }) => {
  ...
  const systemMessage = {
    role: "system",
    content: `Siempre en formato JSON: con ${prompt} para las preguntas : ${
      ageGroup ? data_train_joven : data_train_adolecente
    }`,
  };
  const [usersInRoom, setUsersInRoom] = useState(1);
